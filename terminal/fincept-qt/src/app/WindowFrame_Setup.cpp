...
void WindowFrame::setup_auth_screens() {
    ...
    connect(pricing, &screens::PricingScreen::navigate_dashboard, this, [this]() {
        ...
        dock_router_->navigate("alpha_trader");
    });
...
void WindowFrame::setup_dock_screens() {
    screens::DexterBridge::instance().start();
    dock_router_->register_factory("alpha_trader", []() { return new screens::AlphaTraderScreen; });
    dock_router_->register_factory("alpha_chart", []() { return new screens::AlphaChartScreen; });
