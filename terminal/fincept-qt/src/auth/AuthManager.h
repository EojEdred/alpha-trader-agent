...
class AuthManager : public QObject {
  ...
  public:
    ...
    /// Local Alpha Trader operator — no Fincept cloud login, no pricing gate.
    void enter_local_operator();
    bool is_local_operator() const { return local_operator_; }
